...
// Get Variable
$name = $_POST['bus_name'];
$board = $_POST['board_point'];
$btime = $_POST['board_time'];
$dtime = $_POST['drop_time'];
$busRegi = $_POST['bus_reg_no'];
$drop = $_POST['drop_point'];
$seat = $_POST['max_seats'];
$amount = $_POST['fare'];
...
$sql = "INSERT INTO management (busRegi_no, Bus_name, pickup_loc, start_time, drop_time, destination_loc, max_seat, fare )
VALUES ('$busRegi', '$name', '$board','$btime','$dtime','$drop','$seat','$amount')";
      ...
      <div class="row">
         <!-- left column -->
          <div class="col-md-12">
               ...
               Add Bus Details successfully            </div>
                     </div>
         <div class="col-md-12">
 ...
 <div class="bootstrap-timepicker">
                   ...
                   <div class="col-md-6">
						...
						<div class="form-group has-feedback">
                           ...
                           <input   tabindex="5" type="text" class="form-control required" name="drop_point" data-parsley-trigger="change"	
