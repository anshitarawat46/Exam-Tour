...
<html>
 ...
 <h1>
      ...
      <ol class="breadcrumb">
         <li><a href="adlogin.html"><i class="fa fa-hand-o-up"></i>Home</a></li>
         <li><a href="locationdtl.php">Location</a></li>
      ...
      <div class="row">
         ...
         <div class="col-md-12">
            ...
            <div class="box box-warning">
               ...
               <!-- /.box-header -->
               <!-- form start -->
			    <form role="form" action="inserto.php" method="post" class="validate" enctype="multipart/form-data">
                  <div class="box-body">
                     <div class="col-md-6">                      
						...
						<div class="form-group has-feedback">
                           <label for="exampleInputEmail1">Boarding point Address</label>
                           <input tabindex="5" type="text" class="form-control required" name="baddress" placeholder="Address">
                           <span class="glyphicon  form-control-feedback"></span>
                        </div>
                   ...
                   <div class="col-md-6">
				      ...
				      <div class="form-group has-feedback">
                           <label for="exampleInputEmail1">New Drop Point</label>
                           <input tabindex="3"  type="text" class="form-control required" name="drop_point" data-parsley-trigger="change"	
                           data-parsley-minlength="2" data-parsley-maxlength="15" data-parsley-pattern="^[a-zA-Z0-9\  \/]+$" required="" placeholder=" Boarding Point ">
                           <span class="glyphicon  form-control-feedback"></span>
                        </div>
			
						<div class="form-group has-feedback">
                           <label for="exampleInputEmail1"> Drop point Address</label>
                           <input tabindex="6" type="text" class="form-control required" name="daddress" placeholder="Address">
                           <span class="glyphicon  form-control-feedback"></span>
                        </div>
