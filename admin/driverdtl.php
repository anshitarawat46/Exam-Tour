         ...
         <div class="col-xs-12">
            ...
            <div class="box">
               <div class="box-header">
                  <h3 class="box-title">View Agent/Driver Details</h3>
               </div>
               <!-- /.box-header -->
               <div class="box-body">
...
?>
                     ...
                     <tbody>
                           ...
                           <td class="center">	  
                               ...
                               <a class="btn btn-sm btn-primary" id="<?php echo $row['email_id']; ?>" href="edit_driver.php?email_id=<?php echo $row['email_id']?>">
                              <i class="fa fa-fw fa-edit"></i>Edit</a>
                              <a class="btn btn-sm btn-danger" id="<?php echo $row['email_id']; ?>" href="delete1.php?email_id=<?php echo $row['email_id']?>" onClick="return doconfirm()">
