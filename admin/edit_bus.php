...
$sql = "SELECT * FROM management WHERE busRegi_no = '$busRegi_no'";
...
?>
                     ...
                     <div class="col-md-6">
					      ...
					      <div class="form-group has-feedback">
                           <label for="exampleInputEmail1">Bus Name</label>
                            <input  tabindex="1" type="text" class="form-control required" value=<?php echo $row['Bus_name']; ?> data-parsley-trigger="change"	
						...
						<div class="form-group has-feedback">
						   ...
						   value="<?php echo $row['pickup_loc']; ?> " data-parsley-trigger="change"	
						 ...
						 <div class="bootstrap-timepicker">
							<div class="form-group">
							  ...
							  <div class="input-group">
								<input  tabindex="7" type="text" name="board_time" value="<?php echo $row['start_time']; ?>" class="form-control required">
			 ...
			 <div class="bootstrap-timepicker">
							<div class="form-group">
							  ...
							  <div class="input-group">
								<input  tabindex="7" type="text" name="drop_time" value="<?php echo $row['drop_time']; ?> " class="form-control required">
								<div class="input-group-addon">
								  <i class="fa fa-clock-o"></i>
								</div>
							  </div><!-- /.input group -->
                  ...
                  <div class="box-footer">
				   ...
				   <div class="col-md-6">
				        ...
				        <div class="form-group has-feedback">
                           ...
                           <input  tabindex="2" type="text" class="form-control required" name="bus_reg_no" value="<?php echo $row['busRegi_no']; ?> "data-parsley-trigger="change" data-parsley-minlength="2" data-parsley-maxlength="15"  required="" placeholder="Bus RegiNumber">
                           <span class="glyphicon  form-control-feedback"></span>
                        </div>
						
						 <div class="form-group has-feedback">
                           <label for="exampleInputEmail1">Maximum Seats</label>
                           <input tabindex="4" type="text" class="form-control required" name="max_seats" value="<?php echo $row['max_seat']; ?> "
                           ...
                           <input tabindex="6"  type="text" class="form-control required" name="drop_point" value="<?php echo $row['destination_loc']; ?> "data-parsley-trigger="change"	data-parsley-minlength="2" data-parsley-maxlength="15" required="" placeholder="End Point">
                           <span class="glyphicon  form-control-feedback"></span>
                        </div>
						
						<div class="form-group has-feedback">
                           <label for="exampleInputEmail1">Fare</label>
                           <input tabindex="6"  type="text" class="form-control required" name="fare" value="<?php echo $row['fare']; ?> "data-parsley-trigger="change"	data-parsley-minlength="2" data-parsley-maxlength="15" required="" placeholder="End Point">
                           <span class="glyphicon  form-control-feedback"></span>
                        </div>
