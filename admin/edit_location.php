...
$sql = "SELECT * FROM location WHERE pickup_loc = '$pickup_loc'";
...
?>
               <form role="form" action="submit1.php" method="post"  class="validate" enctype="multipart/form-data">
                  <div class="box-body">                 
                     <div class="col-md-6">
						 ...
						 <div class="form-group has-feedback">
                           ...
                           <input  tabindex="2" type="text" class="form-control required" name="pickup_loc" value="<?php echo $row['pickup_loc']; ?> "data-parsley-trigger="change" data-parsley-minlength="2" data-parsley-maxlength="15"  required="" placeholder="Bus RegiNumber">
                           <span class="glyphicon  form-control-feedback"></span>
                        </div>
						
						 <div class="form-group has-feedback">
                           <label for="exampleInputEmail1">Pickup Address</label>
                           <input  tabindex="2" type="text" class="form-control required" name="start_address" value="<?php echo $row['start_address']; ?> "data-parsley-trigger="change" data-parsley-minlength="2" data-parsley-maxlength="15"  required="" placeholder="Bus RegiNumber">
                           <span class="glyphicon  form-control-feedback"></span>
                        </div>
                  ...
                  <div class="box-footer">
                     <button  tabindex="10" type="submit1.php" class="btn btn-primary">Submit</button>
                  </div>
				   </div>
				   <div class="col-md-6">
				        ...
				        <div class="form-group has-feedback">
                           ...
                           <input  tabindex="2" type="text" class="form-control required" name="destination_loc" value="<?php echo $row['destination_loc']; ?> "data-parsley-trigger="change" data-parsley-minlength="2" data-parsley-maxlength="15"  required="" placeholder="Bus RegiNumber">
                           <span class="glyphicon  form-control-feedback"></span>
                        </div>
                           ...
                           <input tabindex="6"  type="text" class="form-control required" name="drop_address" value="<?php echo $row['drop_address']; ?> "data-parsley-trigger="change"	data-parsley-minlength="2" data-parsley-maxlength="15" required="" placeholder="End Point">
                           <span class="glyphicon  form-control-feedback"></span>
                        </div>
