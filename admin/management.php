...
?>
                     ...
                     <tbody>
                           ...
                           <td class="center">	  
                              ...
                              <a class="btn btn-sm btn-primary" id="<?php echo $row['busRegi_no']; ?>" href="edit_bus.php?busRegi_no=<?php echo $row['busRegi_no']?>">
                              <i class="fa fa-fw fa-edit"></i>Edit</a>
                              <a class="btn btn-sm btn-danger" id="<?php echo $row['busRegi_no']; ?>" href="delete.php?busRegi_no=<?php echo $row['busRegi_no']?>" onClick="return doconfirm()">
